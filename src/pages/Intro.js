            ...
            <div className='center-box'>
              ...
              `heading-text 
               ...
               ${isDiscoverHovered ? 'translate-right' : ''}`
                        ...
                        Sophisticated<br/><span className='heading-text-2'>skincare</span>
                    </h1>
                </div>
                ...
                <div className={`left-section ${isHovered ? 'fade-out' : ''}`}>
                    <div className='left-section-holder'>
                        <div className={`left-section-diamond ${isHovered ? 'fade-out' : ''}`}></div>
                        <button
              ...
              >
                ...
                <div className={`right-section ${isDiscoverHovered ? 'fade-out' : ''}`}>
                    <div className='right-section-holder'>
                        <div className={`right-section-diamond ${isDiscoverHovered ? 'fade-out' : ''}`}></div>
                        <Link to='/testing'>
                            <button
                  className={`take-test-button ${isDiscoverHovered ? 'fade-out' : ''}`}
